...
declare const _default: (prefixCls: string, rootCls?: string, injectStyle?: boolean) => readonly [(node: import("react").ReactElement) => import("react").ReactElement, string, string | undefined];
