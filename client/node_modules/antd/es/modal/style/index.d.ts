...
import type { AliasToken, FullToken, GenerateStyle } from 'antd/es/theme/internal';
import type { GenStyleFn, TokenWithCommonCls } from 'antd/es/theme/util/genComponentStyleHook';
...
declare const _default: (prefixCls: string, rootCls?: string) => readonly [(node: React.ReactElement) => React.ReactElement, string, string | undefined];
