...
import type { AlertConfig, BadgeConfig, ButtonConfig, CardConfig, CollapseConfig, ComponentStyleConfig, ConfigConsumerProps, CSPConfig, DirectionType, DrawerConfig, FlexConfig, FloatButtonGroupConfig, FormConfig, ImageConfig, InputConfig, ListConfig, MenuConfig, ModalConfig, NotificationConfig, PaginationConfig, PopupOverflow, SelectConfig, SpaceConfig, TableConfig, TabsConfig, TagConfig, TextAreaConfig, Theme, ThemeConfig, TourConfig, TransferConfig, WaveConfig, Variant, InputNumberConfig, RangePickerConfig, DatePickerConfig, TimePickerConfig, CascaderConfig, TreeSelectConfig, MentionsConfig } from 'antd/es/config-provider/context';
import { ConfigConsumer, ConfigContext, defaultIconPrefixCls, Variants } from 'antd/es/config-provider/context';
